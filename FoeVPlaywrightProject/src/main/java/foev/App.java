...
public class App {
    private static final String TEXT="Essensgeld 03-2024";
    public static void main(String[] args) {
        try (Playwright playwright = Playwright.create()) {
            ...
            login(page);
            page.pause(); // In dieser Pause den Browser zulassen und Vorlagen und Lastschroftvorlagen anklicken
    ...
    private static void login(Page page) {
        ...
        page.getByLabel("VR-NetKey oder Alias").fill("20**");
        page.getByLabel("PIN").click();
        page.getByLabel("PIN").fill("96++");
